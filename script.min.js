...
generated_toc = {
  generate: function() {
    ...
    if (status && status == "open") {
      ...
      toggle_initially = "Ẩn mục lục";
    } else {
      display_initially = "block";
      toggle_initially = "Hiển thị mục lục";
    }

    cur_head_lvl = "h" + generate_from;
    cur_list_el = document.createElement('ol');
    cur_list_el.style.display = display_initially;
    cur_list_el.style['margin-left'] = "25px";
    cur_list_el.style['line-height'] = "1.5";
    cur_list_el.style['font-size'] = "16px";
    cur_list_el.style["list-style-type"] = "none";
    ...
    a.href = '#aftertoc';
    a.appendChild(document.createTextNode('Bỏ qua mục lục'));
    span.appendChild(a);
    p.appendChild(span);
    ...
    for (var i=0; i<headings.length; i++) {
      ...
      if (!this_head_el.id) {
        ...
        this_head_el.id = generated_toc.bodautiengviet(headings[i].innerText) +"_" + i;
      ...
      while(this_head_lvl > cur_head_lvl) {
        ...
        if (!last_listitem_el) {
          ...
          last_listitem_el.style['font-size'] ="16px";
          
        }
        new_list_el = document.createElement('ol');
        new_list_el.style["font-size"] = "16px";
        new_list_el.style['margin-left'] = "25px";
        new_list_el.style['line-height'] = "1.5";
  ...
  bodautiengviet: function bodauTiengViet(str) {
    str = str.toLowerCase();
